...
router.get('/commandes/:id/lignes', c.getLignesCommande);
router.post('/commandes/:id/lignes', autoriser('admin'), c.ajouterLigneCommande);
router.put('/commandes/:id/lignes/:ligneId', autoriser('admin'), c.modifierLigneCommande);
router.delete('/commandes/:id/lignes/:ligneId', autoriser('admin'), c.supprimerLigneCommande);
