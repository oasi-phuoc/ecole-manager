...
// Mettre à jour Branches.js pour remplacer Code par Périodes/semaine
let branches = fs.readFileSync('./src/pages/Branches.js', 'utf8');
branches = branches
  .replace(/Code/g, 'Périodes/sem')
  .replace(/code/g, 'periodes_semaine')
  .replace(/placeholder="Ex: MATH"/g, 'placeholder="Ex: 4" type="number" min="1" max="20"');
fs.writeFileSync('./src/pages/Branches.js', branches);
