...
const styles = {
  ...
  onglet: { padding: '10px 16px', background: '#ede9fe', border: 'none', borderRadius: '10px 10px 0 0', cursor: 'pointer', fontSize: '14px', fontWeight: '700', color: '#5b21b6', lineHeight: 1, position: 'relative', zIndex: 1, outline: 'none', boxShadow: 'none' },
  ...
  materielBtn: { padding: '8px 12px', border: 'none', borderRadius: '10px 10px 0 0', background: '#ede9fe', color: '#5b21b6', fontWeight: '700', cursor: 'pointer', fontSize: '12px', lineHeight: 1, position: 'relative', zIndex: 1, outline: 'none', boxShadow: 'none' },
  materielBtnActif: { background: '#6366f1', color: 'white', border: 'none', marginBottom: -1, zIndex: 2, boxShadow: '0 -1px 6px rgba(99,102,241,0.22)' },
