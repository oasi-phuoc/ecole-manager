...
const styles = {
  ...
  ongletsWrap: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: 10, marginBottom: '20px', borderBottom: '1px solid #c4b5fd', paddingBottom: 0, flexWrap: 'wrap' },
  onglets: { display: 'flex', gap: '8px', marginBottom: 0, alignItems: 'flex-end', flexWrap: 'wrap' },
  onglet: { padding: '10px 16px', background: '#f8fafc', border: '1px solid #d1d5db', borderBottom: '1px solid #c4b5fd', borderRadius: '10px 10px 0 0', cursor: 'pointer', fontSize: '14px', fontWeight: '700', color: '#64748b', lineHeight: 1, position: 'relative', zIndex: 1 },
  ...
  materielActions: { display: 'flex', gap: 6, flexWrap: 'wrap', alignItems: 'flex-end' },
  materielBtn: { padding: '8px 12px', border: '1px solid #d1d5db', borderBottom: '1px solid #c4b5fd', borderRadius: '10px 10px 0 0', background: '#f8fafc', color: '#64748b', fontWeight: '700', cursor: 'pointer', fontSize: '12px', lineHeight: 1, position: 'relative', zIndex: 1 },
  materielBtnActif: { background: '#6366f1', color: 'white', borderColor: '#6366f1', borderBottom: '1px solid #6366f1', marginBottom: -1, zIndex: 2, boxShadow: '0 -1px 6px rgba(99,102,241,0.22)' },
