...
export default function EmploiDuTemps() {
    ...
    <html>
      <head>
        ...
        <style>
          ...
          .a3-main { width:auto; }
          .a3-main table { margin:0 !important; }
          ...
          .day-gap td { border: none !important; background: transparent !important; height: ${a3Semaine && hauteurLigne ? `${hauteurLigne}px` : (a3Semaine ? '0' : '14px')}; padding: 0 !important; }
  ...
  const buildPlanningSemainePrintHtml = ({ creneauxListe, getCellText, getCellData, showPauseRows = true, titreBanniere = '', titreBanniereGauche = '', site = '', layoutOnglet = 'classes' }) => {
    const ROW_H = PDF_LIGNE_CLASSE_SALLE_PROF;
    const CRENEAU_W = PDF_COLONNE_HORAIRE_CLASSE_SALLE_PROF;
    const FONT = '11pt';
        ...
        <div class="section">
          <table class="a3-grille" style="border-collapse:collapse;height:auto;table-layout:fixed;margin:0;--a3-grille-w:${tableWidth};">
            ...
            <tbody>
              ...
              <tr>${encadrerColonnesProfsHtml(profHeaders, htmlThHoraire, htmlThHoraire, SPACER_TH_HTML)}</tr>
              ${rows.join('')}
            </tbody>
          </table>
        </div>
        ...
        <table class="a3-wrap">
          ...
          <tbody>
            <tr>
              ...
              <td class="a3-main">
                <table class="a3-grille" style="border-collapse:collapse;table-layout:fixed;margin:0;--a3-grille-w:${tableWidth};">
                  ${colgroup}
                  <thead>
                    <tr>
                      ${encadrerColonnesProfsHtml(profHeaders, htmlThHoraire, htmlThHoraire, SPACER_TH_HTML)}
                    </tr>
                  </thead>
                  <tbody>
                    ${rows.join('')}
  ...
  const htmlOptsPdfOnglet = (onglet, extra = {}) => {
    return {
      paysage: true,
      format: 'A3',
      margin: marginPdfA3('landscape'),
      ...extra,
      layoutOnglet: onglet,
      hauteurLigne: PDF_LIGNE_CLASSE_SALLE_PROF,
      largeurColonne: PDF_COLONNE_HORAIRE_CLASSE_SALLE_PROF,
    };
  };
