...
const styles = {
  ...
  header:{display:'flex',alignItems:'center',gap:15,marginBottom:30,width:'100%'},
  ...
  affActionsWrap:{display:'flex',alignItems:'center',gap:10,marginBottom:30,background:'white',padding:'12px 16px',borderRadius:10,boxShadow:'0 2px 8px rgba(0,0,0,0.06)',flexWrap:'wrap'},
