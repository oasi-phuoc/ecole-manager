...
const styles = {
  ...
  navItem: { padding: '10px 14px', borderRadius: '10px 10px 0 0', cursor: 'pointer', fontSize: '14px', fontWeight: '700', border: '1px solid #d1d5db', borderBottom: '1px solid #c4b5fd', background: '#f8fafc', color: '#64748b', marginBottom: '6px', lineHeight: 1.2, position: 'relative', zIndex: 1 },
  navItemActif: { background: '#6366f1', color: 'white', borderColor: '#6366f1', borderBottom: '1px solid #6366f1', marginBottom: '5px', transform: 'translateX(2px)', zIndex: 2 },
  content: {},
