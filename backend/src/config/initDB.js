...
const initDB = async () => {
  try {
    ...
    await pool.query(`CREATE TABLE IF NOT EXISTS eleves (id SERIAL PRIMARY KEY, utilisateur_id INTEGER REFERENCES utilisateurs(id), classe_id INTEGER REFERENCES classes(id), date_naissance DATE, sexe VARCHAR(10), adresse TEXT, telephone VARCHAR(20), nom_parent VARCHAR(200), telephone_parent VARCHAR(20), statut VARCHAR(20) DEFAULT 'actif');`);
    ...
    await pool.query(`ALTER TABLE eleves ADD COLUMN IF NOT EXISTS sexe VARCHAR(10)`);
