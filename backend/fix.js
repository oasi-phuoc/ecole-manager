...
fs.writeFileSync('./src/controllers/profsController.js', `const pool = require('../config/database');
...
const creerProf = async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query(
      ...
      [nom, prenom, email, hash, telephone||null, specialite||null, adresse||null, npa||null, lieu||null, sexe||null, taux_activite||null, periodes_semaine||null, date_naissance||null, avs||null, type_contrat||null, type_permis||null]
    );
...
const modifierProf = async (req, res) => {
  ...
  try {
    ...
    if (mot_de_passe && mot_de_passe.trim() !== '') {
      ...
      params = [nom, prenom, email, actif!==undefined?actif:true, hash, telephone||null, specialite||null, adresse||null, npa||null, lieu||null, sexe||null, taux_activite||null, periodes_semaine||null, date_naissance||null, avs||null, type_contrat||null, type_permis||null, req.params.id];
    } else {
      ...
      params = [nom, prenom, email, actif!==undefined?actif:true, telephone||null, specialite||null, adresse||null, npa||null, lieu||null, sexe||null, taux_activite||null, periodes_semaine||null, date_naissance||null, avs||null, type_contrat||null, type_permis||null, req.params.id];
    }
...
console.log('profsController.js OK !');